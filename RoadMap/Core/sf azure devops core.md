...
git clone, git init, git add, git status, git commit, git push, git fetch, git pull, pull request-PR, git merge, merge conflicts, git rebase, git cherry-pick, git squash, remote vs local
